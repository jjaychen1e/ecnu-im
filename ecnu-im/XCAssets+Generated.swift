...
internal enum Asset {
  internal enum _3rd {
    internal enum WebController {
      internal static let icBack = ImageAsset(name: "icBack")
      internal static let icFront = ImageAsset(name: "icFront")
    }
  }
  ...
  internal enum DefaultTheme {
    ...
    internal static let defaultThemeCardColor = ColorAsset(name: "defaultThemeCardColor")
    internal static let defaultThemeLinkColor = ColorAsset(name: "defaultThemeLinkColor")
    internal static let defaultThemeMentionColor = ColorAsset(name: "defaultThemeMentionColor")
