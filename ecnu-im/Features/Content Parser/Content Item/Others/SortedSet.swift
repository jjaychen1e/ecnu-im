/*
 ...
 can be user-defined.
 */
// https://github.com/raywenderlich/swift-algorithm-club/blob/master/Sorted%20Set/SortedSet.swift
public struct SortedSet<T: Comparable>: Collection {
    ...
    public func index(after i: Int) -> Int {
        internalSet.index(after: i)
    }

    public var startIndex: Int {
        internalSet.startIndex
    }

    public var endIndex: Int {
        internalSet.endIndex
    }
    ...
    public mutating func popFirst() -> T? {
        if count > 0 {
            return internalSet.remove(at: 0)
        }
        return nil
    }
    ...
    public mutating func popLast() -> T? {
        if count > 0 {
            return internalSet.remove(at: count - 1)
        }
        return nil
    }
