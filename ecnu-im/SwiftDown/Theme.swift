...
public struct Theme {
    ...
    var backgroundColor: UniversalColor = .clear
    var tintColor: UniversalColor = .blue
    var cursorColor: UniversalColor = .blue
    ...
    private mutating func configureStyles(_ attributes: [String: AnyObject]) {
    ...
    private mutating func configureStyle(_ attributes: [String: AnyObject]) -> [NSAttributedString
        .Key: Any]? {
    ...
    private mutating func configureEditor(_ attributes: [String: String]) {
        attributes.forEach { key, value in
